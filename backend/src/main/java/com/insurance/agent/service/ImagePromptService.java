...
public class ImagePromptService {
    ...
    private static String buildWechatCoverPrompt(String ratio) {
        ...
        return ("""
                ...
                - ⛔ 非必要不出现具体的日期或时间（如 "2024 年 3 月"、"今年""明年"、"截止 X 月 X 日" 等）。日期会让封面快速过期，除非主题本身就是政策时间节点（如"医保改革2024落地"），否则一律不要写。
    ...
    private static String buildWechatBatchPrompt(int count, String ratio) {
        ...
        return ("""
                ...
                - ⛔ 非必要不出现具体的日期或时间（如 "2024 年 3 月"、"今年""明年"、"截止 X 月 X 日" 等）。封面图和正文图都不要出现日期文字，除非主题本身就是政策时间节点。
